...
INSERT INTO tb_position (name, activated, updated_at, created_at) VALUES ('PCP', false, TIMESTAMP WITH TIME ZONE '2026-02-23T15:00:00Z', TIMESTAMP WITH TIME ZONE '2026-02-23T15:00:00Z');
...
--INSERT INTO tb_role (id, authority, title, title_url, parent, parent_url) VALUES (8, 'ROLE_CHECKLIST', 'Checklist', '/checklist', 'Qualidade', '/quality');
...
--INSERT INTO tb_notification (message, viewed, action_url, user_id, created_by_user_id, auto_delete, created_at) VALUES ('Novo evento!!', false, '/', 1, 3, true, TIMESTAMP WITH TIME ZONE '2026-01-21T11:00:00Z');
--INSERT INTO tb_notification (message, viewed, action_url, user_id, created_by_user_id, auto_delete, created_at) VALUES ('Memorando 3921 - Equipamento estruturado com a cor errada.', false, '/general/memorando/1', 1, 2, false, TIMESTAMP WITH TIME ZONE '2026-01-19T15:00:00Z');
